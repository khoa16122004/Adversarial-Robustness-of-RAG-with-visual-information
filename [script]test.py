...
# data
data_sample_id = 100
json_path = os.path.join("/content/drive/MyDrive/VSRAGATTACK/split_corpus",
                         str(data_sample_id),
                         'annot.json')
...
with open(json_path, "r") as f:
    ...
    img_paths = [os.path.join(f"/content/drive/MyDrive/VSRAGATTACK/split_corpus/{data_sample_id}/images",
